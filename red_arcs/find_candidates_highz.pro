pro find_candidates_highz,clustername
...
if dim[0] eq 125 then begin
   ...
   g_mag  = reform(data[43,*])
   y_mag = reform(data[85,*])
   z = reform(data[117,*])
   bpz = reform(data[109,*])
endif else stop,'Stop(41): Number of Columns is unknown.'

;g-i selection
lessgood = where(z gt 1.4 and i_mag-y_mag gt 1. and y_mag lt 20.5 and y_mag ne -99 and z lt 1.7)
