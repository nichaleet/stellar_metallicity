...
pro sps_fit::fitmg, science, noredraw=noredraw, nostatusbar=nostatusbar
    ...
    wonmg = where(science.fitmgmask eq 1 and finite(science.contdiv) and finite(science.contdivivar) and science.contdivivar gt 0, conmg) ;and restlambda gt 5150.
    science.fitmgmask = 0
    ...
    contmask = science.contmask
	;stop
    contmask(where(contmask ne 1)) = 1
    dataivar = science.contdivivar
        ...
        3: begin        ;rest frame
           ...
           ;;finish highligting fit mask
            ...
            if science.fe gt -10 then begin
               oplot, science.lambda/(1d + znow), science.spsspecfullfe, color=fsc_color('darkgreen')
            ...
            if science.mg gt -10 and cmgregion gt 0 then begin
               mgregion = where(science.fitmgmask eq 1)
               oplot, science.lambda(mgregion)/(1d + znow), science.spsspecfullmg(mgregion), color=fsc_color('blue')
