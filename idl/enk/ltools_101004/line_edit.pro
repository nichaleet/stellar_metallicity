...
pro line_edit_event,event
	common line_edit_common,info,xarray,yarray,m,m1,m2,rsave,gsave,bsave,st_flags,existstflags
	...
	'WRITE': begin
		...
		'Write.Postscript File': begin
			...
			line_edit_plot,info,xarray,yarray,m,m2,/ps
			device,/close
	...
	'UNZOOM': begin
		...
		line_edit_plot,info,xarray,yarray,m,m2
		end
	'RANGE': line_edit_plot,info,xarray,yarray,m,m2
	'XLOG': begin
...
;
pro line_edit_plot,info,x,y,m1,m2,ps=ps
...
pro line_edit,xin,yin,mask,mask2,stflags=stflags,title=title,xtitle=xtitle,ytitle=ytitle, $
