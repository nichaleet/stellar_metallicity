function get_moog7, xin, a
    ...
    moogspec = interp_moog7(teff, logg, feh, alpha)
    ;moogspec = interp_moog7(teff, logg, feh, alpha, mooglambda=mooglambda, /fullres)
    if 0 then begin
...
;        endfor
    ...
    if smoothfactor gt 0 then moogspec = smooth_gauss_wrapper(dl, moogspec, x, smoothfactor, ivar1=contdivivar)
