function get_moog6, xin, a
    common moog, datalambda, dlam, moogmask, contmask, contdiv, contdivivar, smoothfactor, phot, moogcontrevise
...
;        endfor
            ...
            bkpt = slatec_splinefit(dl[won], moogspec[won], coeff, invvar=contdivivar[won], bkspace=150, upper=5, lower=5, /silent)
    ...
    ;        end
    ;    endcase
    ;    won = where(moogmaski[wwhole] eq 1 and finite(contdivivar[wwhole]) and contdivivar[wwhole] gt 0.0, complement=woff, con) + wwhole[0]
