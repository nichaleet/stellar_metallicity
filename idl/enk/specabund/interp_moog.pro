...
function interp_moog, teff, logg, feh, alpha, mooglambda=mooglambda, fullres=fullres
        ...
        for j=0,ilogg-1 do begin
            for m=0,ifeh-1 do begin
                for n=0,ialpha-1 do begin
                    moogspeci = read_moog_bin(tteff[i], tlogg[j], tfeh[m], talpha[n], n=nmoog, status=status, fullres=fullres)
