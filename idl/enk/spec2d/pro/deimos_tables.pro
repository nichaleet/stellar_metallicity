...
; check for, and throw out, 'ghost' slits
  ...
  if gct gt 0 then begin
      ...
      for i=0,gct-1 do begin                                             ;ENK: added for loop 2010-08-13
          desislits=desislits[where(desislits.dslitid NE baddslitid[i])]
          bluslits=bluslits[where(bluslits.dslitid NE baddslitid[i])]
      endfor
