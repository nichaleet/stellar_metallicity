...
function airindex_buie,wave,pressure,temp,relhum

wave = double(wave)
pressure = double(pressure)
temp = double(temp)
relhum = double(relhum)
n = double(64.328) + 29498.1/(146.0 - (1d / wave)^2) + 255.4/(41.0 - (1d / wave)^2)

pfac = double(pressure) * (1d + (1.049-0.0157*temp)*1.0d-6*pressure)/$
                              (720.883*(1.0+0.003661*temp))

dt = 100d - temp
logp = double(2.8808) - 5.67*dt/(274.1+temp-0.15*dt)
f = relhum * logp^10d
