...
; the way to edge
  ...
  thresh *= 3.
  ;case 1 of
  ;    thresh gt 10000: thresh *= 0.4 ;ENK 8-13-2010, valid for n6822a slitmask, chip 7
  ;    thresh lt 2000: thresh *= 5 ;ENK 8-13-2010, valid for n6822a slitmask, chip 8
  ;    thresh gt 5000: thresh *= 0.5
  ;    else:
  ;endcase
  ...
  if 0 then begin                                                       ;ENK
      resetplot                                                         ;ENK
      plot, yrow                                                        ;ENK
      oplot, [0, 10000], [thresh, thresh], color=fsc_color('red')       ;ENK
      oplot, [0, 10000], [-thresh, -thresh], color=fsc_color('red')     ;ENK
      stop                                                              ;ENK
  endif                                                                 ;ENK
