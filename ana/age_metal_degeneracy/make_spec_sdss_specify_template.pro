function make_spec_sdss_specify_template,grid_feh,grid_age,science
...
common get_sps, dlam, dataivar, datalam, wonfit, contmask, normalize,rest
	...
	for iz=0,nfeh-1 do for ia=0,nage-1 do begin
		spsspec = get_sps_obs_sdss(xmp,[grid_feh[iz,ia],grid_age[iz,ia],vdisp,redshift])
		str = {spec:spsspec,feh:grid_feh[iz,ia],age:grid_age[iz,ia]}
