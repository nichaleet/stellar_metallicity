pro test_degeneracy_formation_time2
...
;open or make the mock set of galaxies
	if file_test('mock_gal_degeneracy2.fits') eq 0 then make_mock_gal_degeneracy2 
	sdss = mrdfits('mock_gal_degeneracy2.fits',1)
	if file_test('mock_cl0024_degeneracy2.fits') eq 0 then make_mock_cl0024_degeneracy2
	sci = mrdfits('mock_cl0024_degeneracy2.fits',1)
...
;plotting
	...
	psname='Formation_Redshift_mock2.eps'
	...
	psname='FEH_deviation_mock2.eps'
	Delta = '!9'+string("104B)+'!x'
	Delta = '!9'+string("104B)+'!x'
	device, filename = psname,xsize = 15,ysize = 10, $
			xoffset = 0,yoffset = 0,scale_factor = 1.0,/encapsulated,/color
