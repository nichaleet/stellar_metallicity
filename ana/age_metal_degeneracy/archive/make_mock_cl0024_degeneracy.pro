pro make_mock_cl0024_degeneracy
...
;a tight MZR but scattered by age-metal degeneracy
	...
	massrange = [9.0,11.]
	ngals = 100.
	SNrange = [6,10] ;SDSS samples
	z=0.4
	mzrparam=[9.01704,9.91704,0.817038]
	;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
	indi = {z:z,sn:0.,mass:0.,fehideal:0.,ageideal:0.,feh:0.,feherr:0.,age:0.,ageerr:0.}
	...
	for i=0,ngals-1 do begin
		massnow = str(i).mass
		minage = 1. ;1 Gyr
		maxage = 5.*massnow-41.< 8 ;function of mass but less than 10 Gyr
	...
	spec_arr = mrdfits('new_grid_spec.fits',1)
	...
	mwrfits,str,'mock_cl0024_degeneracy.fits',/silent,/create
end
